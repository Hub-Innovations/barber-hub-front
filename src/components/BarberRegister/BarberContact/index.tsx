...
function BarberRegisterContact() {
  ...
  return (
    <>
      {/* lembrar que aqui vai ter um if que só mostra caso tenha o link da barbearia */}
      <Styled.ShowBarberLinkContainer>
        <Styled.SectionTitle>
          [Barber name] aqui está o link da sua barbearia!
        </Styled.SectionTitle>
